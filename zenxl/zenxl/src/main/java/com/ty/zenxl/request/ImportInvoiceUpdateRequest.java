...
/**
 * Represents the request DTO for {@code ImportInvoice}.
 * 
 * Contains bean validation properties, to validate the request object using
 * {@code @Valid} in {@code ZenxlImportController}
 * 
 * @author Indrajit
 * @author Abhishek
 * @author Swathi
...
@NoArgsConstructor
@Builder
public class ImportInvoiceUpdateRequest {
	...
	@Valid
	@NotNull(message = "itemUpdateRequest cannot be null")
