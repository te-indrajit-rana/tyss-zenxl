...
/**
 * Represents the request DTO for {@code CertificateTypeDetails} for update
 * purpose.
 * 
...
public class UpdateCertificateTypeRequest {
	...
	@NotNull(message = "certificateType must not be null.")
	@NotBlank(message = "certificateType must not be blank.")
